...
int main(void)
{
    printf("\033[2J");
    printf(
        "\n\033[1;33m--- GENERAL COMMANDS ---\033[0m\n"
        ...
        "  \033[1;33mrun\033[0m       - Run an ELF program       "
        "\033[1;33mbaoc\033[0m        - Compile C to ELF\n\n"
    ...
    printf("To see what any command does, type '\033[1;33mwhatis\033[0m' followed by the command name.\n");
